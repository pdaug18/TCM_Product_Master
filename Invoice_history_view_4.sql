...
left join SILVER_DATA.TCM_SILVER.MASTER_PRODUCT_TABLE mpt on lh.id_item = mpt."Product ID/SKU"
...
) r on lh.id_item = r.id_item and lh.id_loc = r.id_loc_home and r.rn = 1
